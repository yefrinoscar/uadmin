...
import { ToastActionElement } from "./sonner"

const TOAST_LIMIT = 1
const TOAST_REMOVE_DELAY = 1000000

/**
 * A toast is an object that is passed to the `useToast` hook
 * to be rendered by the `Toaster` component.
 *
 ...
 * @property {React.ReactNode} [action] - The action of the toast.
